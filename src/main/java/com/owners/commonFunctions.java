...
public class commonFunctions {
	...
	public void relaunchApp(AndroidDriver<AndroidElement> driver) {
		...
		driver.closeApp();
		driver.launchApp();
		// driver.startActivity("com.owners.buyer",
		// "com.owners.buyer.MainActivity");
		try {
	...
	public void clearAllFilters(AndroidDriver<AndroidElement> driver) throws InterruptedException {
		wait.until(ExpectedConditions.elementToBeClickable(navigatingSearchTab));
		driver.findElement(navigatingSearchTab).click();
	...
	public void openFSBOProperty(AndroidDriver<AndroidElement> driver) {
